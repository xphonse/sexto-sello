...
const PRAYERS: Prayers = [
    {
        ...
        paragraphs: [
            [
                'La Preciosísima Sangre de Nuestro Señor Jesucristo, que sólo representada en Egipto, libró a los israelitas del brazo fuerte de Dios: Nos libre, nos guarde y nos defienda de todo cuando no nos podamos librar ni guardar, en este día, en esta hora y en todo lo restante de nuestra vida.',
            ],
            [
            ...
            [
                'Misterio Altísimo de la Santísima y Beatísima Trinidad, danos, Señor y Dios Nuestro, tu sagrada y divina bendición; la de tu poder que eres Nuestro Padre Eterno, la de tu poder que eres Nuestro Padre Jesucristo, la de tu poder que Eres Nuestro Padre Dios Espíritu Santo Trino y uno en verdad.',
            ],
    ...
    },
    {
        ...
        paragraphs: [
            ...
            [
                'El pan nuestro de cada día dánoslo el día de hoy. Señor, perdona nuestras faltas y haz que perdonemos a nuestros hermanos con la caridad y el amor con que tú nos perdonas, no nos dejes caer en la tentación, líbranos de todo mal y desgracia.',
            ],
    ...
    },
    {
        ...
        paragraphs: [
            [
                'Dios te salve María y te llenó de Gracia, el Señor fue contigo, bendita fuiste entre las mujeres y bendito el fruto de tu vientre que es Jesús. Santa María, Madre de Jesús: ruega por nosotros los pecadores e intercede por los desdichados en este día y en los restantes de nuestra vida.',
            ],
        ],
    },
    {
        id: '5',
        page: '6',
        title: 'ORACION DADA POR NUESTRO DIOS',
        paragraphs: [
            [
                'Luz que iluminas el Solio de mi Padre, ilumina las tinieblas de los que en ellas se encuentran. Desde tu Trono Supremo ser, apiádate de los que están sufriendo.',
            ],

            [
                'Cetro del Poder, baja y aquieta la naturaleza obra milagro entre tantos que sufren, Dios de bondad y de clemencia que sufriste por el mortal cruel sacrificio, por el sangre derramaste, una gota de esa sangre derrama cual bálsamo sobre la desgracia que aqueja a la humanidad. Padre Amado, Supremo Hacedor, que en el hueco de tu Divina mano tienes el destino del mundo y del mortal, con el indice, Señor, señala el bien a la humanidad y con la diestra expele de ella su desgracia y su maldad, mira, Señor, nuestros ojos lloran al ver cómo sufren nuestros hermanos, como te piden que tu clemencia y misericordia les acompañe, Padre, Padre, extiende tu diestra y con tu santo manto cubre a la humanidad',
            ],
        ],
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            [
                ...
                'Creo que fue mujer Santa y Pura.',
                'Creo en el Perdón de nuestras faltas y en la vida eterna en el seno del Señor.',
            ],
        ],
    },
    {
        id: '8',
        page: '9',
        title: 'LOS PRECEPTOS DE MOISES, DE JESUS Y LOS DE ELIAS, EL HIJO DEL HOMBRE',
        paragraphs: [
            ['AÑO DEL SEÑOR 1° DE SEPTIEMBRE DE 1866'],
            ...
            [
                ...
                '15 No trates con desprecio a los que sufren enfermedades que tú llamas asquerosas.',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            [
                ...
                'De atribuirse imperfecciones.',
                'De la hipocresía.',
                'De odio o mala voluntad en contra de nuestros hermanos.',
                'De la muerte a la vida de la Gracia.',
                'De malas palabras.',
                'Del fanatismo religioso.',
                'De dividirnos en contra de nuestros hermanos.',
                'Del egoísmo.',
                'Del parricidio.',
                'Del fratricidio.',
                'Del infanticidio.',
                'De la soberbia.',
                'De deberes carnales con vicio.',
                'Del camino de la iniquidad.',
                'Del hombre injusto.',
                'De la ingratitud.',
                'De la avaricia.',
                'De la confusión.',
                'De contagios carnales.',
                'De la mala elección en nuestros estados.',
                'De la desgracia en nuestros trabajos o profesiones.',
                'Del mal tino en nuestras determinaciones.',
                'De la falta de tus beneficios espirituales.',
                'De la burla o befa de los malvados.',
                'De la muerte por las fieras.',
                'Del extravío en los caminos.',
                'De la mala navegación.',
                'De la infidelidad en los esposos.',
                'De las enfermedades de largo tiempo.',
                'De la muerte por agua.',
                'De la muerte por fuego.',
                'De ser precipitados de las alturas.',
                'Del mal carácter.',
                'De la falta de fe.',
                'De la falta de confianza en Ti.',
                'Del envenenamiento.',
                'De la miseria.',
                'De todo mal y toda desgracia.',
            ],
        ],
    },
    {
        ...
        title: 'CANTICOS ',
        paragraphs: [
            ['(Al final de cada renglón se dice Bendito es el Señor Dios.)'],
    ...
    },
    {
        id: '11',
        page: '12',
        title: 'INVOCACION PARA EL DESCENDIMIENTO',
        paragraphs: [
            [
    ...
    },
    {
        ...
        paragraphs: [
            [
                'Te alabamos Señor Dios Todopoderoso, Creador del Cielo, de la tierra y de todas las cosas visibles invisibles.',
                'Confesamos que eres el Creador del Universo eterno.',
                'A Ti Padre Eterno en quién los hombres creemos y adoramos.',
                'A Ti todas las cosas que Tú creaste te aclaman: ¡Santo! ¡Santo! ¡Santo!',
                'Tú llenas el Cielo y la Tierra de tu Gloria.',
                'A Ti te llamaron los Profetas.',
                'A Ti te aclamaron los Apóstoles.',
                ...
                'En ti hemos puesto nuestras esperanzas y te pedimos que no seamos confundidos eternamente',
                'Así sea.',
            ],
        ],
    },
